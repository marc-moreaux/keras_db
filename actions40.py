...
def build_dataset(official_splits = True):
    ...
    for file_name in files:
        if file_name != "actions.txt":
            with open(data_path+"ImageSplits/"+file_name, 'r') as file:
                for img_name in file:
                    ...
                    #
                    if not os.path.isdir(data_path+"data/"+set_name+'/'+class_name):
                        os.mkdir(data_path+"data/"+set_name+'/'+class_name+'/')
                    copyfile(data_path+"images/"+img_name,
                             data_path+"data/"+set_name+'/'+class_name+'/'+img_name_new)
